...
<meta charset="utf-8" />
<base href="<%=basePath%>">
<title>投资数据网 - 历史固定资产与在建工程走势图</title>
<meta name="viewport" content="width=1010" />
<meta name="keywords" content="历史固定资产与在建工程，历年固定资产与在建工程查询" />
<meta name="description" content="上市公司固定资产与在建工程，上市公司固定资产与在建工程走势图" />
...
<body>
	...
	<div class="report_tip">
		<span style="font-weight:bold;">指标名称：</span>固定资产 + 在建工程<br>
		<span style="font-weight:bold;">计算公式：</span>固定资产 + 在建工程<br>
