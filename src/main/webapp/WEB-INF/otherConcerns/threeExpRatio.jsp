...
<meta charset="utf-8" />
<base href="<%=basePath%>">
<title>投资数据网 - 历史三项费用率走势图</title>
<meta name="viewport" content="width=1010" />
<meta name="keywords" content="历史存三项费用率，历年三项费用率查询" />
<meta name="description" content="上市公司三项费用率，上市公司三项费用率走势图" />
...
<body>
	...
	<div class="report_tip">
		<span style="font-weight:bold;">指标名称：</span>三项费用率<br>
		<span style="font-weight:bold;">计算公式：</span>(今年三项费用(销售，财务，管理) - 去年三项费用) / 去年三项费用  × 100% <br>
		<span style="font-weight:bold;">说明：</span><br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;该指标旨在考评企业三项费用的变动情况，若三项费用变化较大要根据财报查看是什么原因导致了这种变化，对公司经营有何影响。
	</div>
	<!-- 图标展示区 -->
