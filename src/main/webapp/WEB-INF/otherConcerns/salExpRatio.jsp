...
<meta charset="utf-8" />
<base href="<%=basePath%>">
<title>投资数据网 - 历史销售费用率走势图</title>
<meta name="viewport" content="width=1010" />
<meta name="keywords" content="历史销售费用率，历年销售费用率查询" />
<meta name="description" content="上市公司销售费用率，上市公司销售费用率走势图" />
...
<body>
	...
	<div class="report_tip">
		<span style="font-weight:bold;">指标名称：</span>销售费用率<br>
		<span style="font-weight:bold;">计算公式：</span>(今年销售费用 - 去年销售费用) / 去年销售费用  × 100% <br>
		<span style="font-weight:bold;">说明：</span><br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;该指标旨在考评企业销售费用的变动情况，若变化较大要根据财报查看是什么原因导致了这种变化，对公司经营有何影响。
	</div>
	<!-- 图标展示区 -->
