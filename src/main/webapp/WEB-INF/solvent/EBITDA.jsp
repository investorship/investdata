...
<meta charset="utf-8" />
<base href="<%=basePath%>">
<title>投资数据网 - 历史税息折旧及摊销前利润(EBITDA)走势图</title>
<meta name="viewport" content="width=1010" />
<meta name="keywords" content="历史税息折旧及摊销前利润(EBITDA)，历年税息折旧及摊销前利润(EBITDA)查询" />
<meta name="description" content="上市公司税息折旧及摊销前利润(EBITDA)，上市公司税息折旧及摊销前利润(EBITDA)走势图" />
...
<body>
	...
	<div class="report_tip">
		<span style="font-weight:bold;">指标名称：</span>税息折旧及摊销前利润(EBITDA)<br>
		<span style="font-weight:bold;">计算公式：</span>净利润+所得税+固定资产折旧+无形资产摊销+长期待摊费用摊销+偿付利息所支付的现金(取财务费用中的利息支出项)<br>
		<span style="font-weight:bold;">说明：</span><br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;由于在EBIT中，存在固定资产折旧，无形资产摊销等非付现因素,而EBITDA为扣除折旧摊销费用之前的利润指标，企业间不同的折旧和摊销政策也不会影响对该企业盈利能力的评估。
	</div>
	<!-- 图标展示区 -->
