...
<meta charset="utf-8" />
<base href="<%=basePath%>">
<title>投资数据网 - 历史有息负债走势图</title>
<meta name="viewport" content="width=1010" />
<meta name="keywords" content="历史有息负债，历年有息负债查询" />
<meta name="description" content="上市公司有息负债，上市公司有息负债走势图" />
...
<body>
	...
	<div class="report_tip">
		<span style="font-weight:bold;">指标名称：</span>有息负债<br>
		<span style="font-weight:bold;">计算公式：</span>长期有息负债 + 短期有息负债 (长期借款 + 应付债券 + 短期借款 + 应付票据 + 一年内到期的非流动负债)<br>
		<span style="font-weight:bold;">说明：</span><br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;通过该指标可以观察企业有息负债的增减情况，在加息周期中，过多的有息负债将给企业利润带来比较大的影响。
	</div>
	<!-- 图标展示区 -->
