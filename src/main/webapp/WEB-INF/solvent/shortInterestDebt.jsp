...
<meta charset="utf-8" />
<base href="<%=basePath%>">
<title>投资数据网 - 历史短期有息负债走势图</title>
<meta name="viewport" content="width=1010" />
<meta name="keywords" content="历史短期有息负债，历年短期有息负债查询" />
<meta name="description" content="上市公司短期有息负债，上市公司短期有息负债走势图" />
...
<body>
	...
	<div class="report_tip">
		<span style="font-weight:bold;">指标名称：</span>短期有息负债<br>
		<span style="font-weight:bold;">计算公式：</span>短期借款+应付票据+一年内到期的长期借款(一年内到期的非流动负债)<br>
		<span style="font-weight:bold;">说明：</span><br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;该指标用于查看企业短期负债中，需要支付利息的负债情况。利息将通过财务费用减少企业当期利润。
	</div>
	<!-- 图标展示区 -->
