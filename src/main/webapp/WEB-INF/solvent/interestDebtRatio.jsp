...
<meta charset="utf-8" />
<base href="<%=basePath%>">
<title>投资数据网 - 历史有息负债比率走势图</title>
<meta name="viewport" content="width=1010" />
<meta name="keywords" content="历史有息负债比率，历年有息负债比率查询" />
<meta name="description" content="上市公司有息负债比率，上市公司有息负债比率走势图" />
...
<body>
	...
	<div class="report_tip">
		<span style="font-weight:bold;">指标名称：</span>有息负债比率<br>
		<span style="font-weight:bold;">计算公式：</span>带息负债总额/负债总额 (长期借款 + 应付债券 + 短期借款 + 应付票据 + 一年内到期的非流动负债 / 负债总额)<br>
		<span style="font-weight:bold;">说明：</span><br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;企业负债当中需要支付利息的债务占总负债的比率，这个比率越低，证明企业举债成本越低，相对来说利润也就会提高。
	</div>
	<!-- 图标展示区 -->
