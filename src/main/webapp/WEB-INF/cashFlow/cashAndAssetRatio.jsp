...
<meta charset="utf-8" />
<base href="<%=basePath%>">
<title>投资数据网 - 历史总资产现金回收率走势图查询</title>
<meta name="viewport" content="width=1010" />
<meta name="keywords" content="历史总资产现金回收率，历年总资产现金回收率查询" />
<meta name="description" content="上市公司总资产现金回收率查询，上市公司历年总资产现金回收率走势图" />
...
<body>
	...
	<div class="report_tip">
		<span style="font-weight:bold;">指标名称：</span>总资产现金回收率<br>
		<span style="font-weight:bold;">计算公式：</span>经营现金流量净额/平均资产总额(期初资产总额 + 期末资产总额 / 2) × 100% <br>
		<span style="font-weight:bold;">说明：</span><br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;该指标旨在考评企业总资产产生现金的能力，该比值越大越好。
	</div>
	<!-- 图标展示区 -->
