...
<meta charset="utf-8" />
<base href="<%=basePath%>">
<title>投资数据网 - 历史应收账款周转天数走势图</title>
<meta name="viewport" content="width=1010" />
<meta name="keywords" content="历史应收账款周转天数，历年应收账款周转天数查询" />
<meta name="description" content="上市公司应收账款周转天数查询，上市公司应收账款周转天数走势图" />
...
<body>
	...
	<div class="report_tip">
		<span style="font-weight:bold;">指标名称：</span>应收账款周转天数<br>
		<span style="font-weight:bold;">计算公式：</span> 360 / 应收账款周转率 <br>
