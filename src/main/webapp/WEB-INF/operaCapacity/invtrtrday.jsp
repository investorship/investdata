...
<meta charset="utf-8" />
<base href="<%=basePath%>">
<title>投资数据网 - 历史存货周转天数走势图</title>
<meta name="viewport" content="width=1010" />
<meta name="keywords" content="历史存货周转天数，历年存货周转天数查询" />
<meta name="description" content="上市公司存货周转天数，上市公司存货周转天数走势图" />
...
<body>
	...
	<div class="report_tip">
		<span style="font-weight:bold;">指标名称：</span>存货周转天数<br>
		<span style="font-weight:bold;">计算公式：</span> 360 / 存货周转率 <br>
		<span style="font-weight:bold;">说明：</span><br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;存货周转天数(Days sales of inventory) 是指企业从取得存货开始，至消耗、销售为止所经历的天数。周转天数越少，说明存货变现的速度越快。
