...
<meta charset="utf-8" />
<base href="<%=basePath%>">
<title>投资数据网 - 历史公允价值变动与利润总额之比走势图</title>
<meta name="viewport" content="width=1010" />
<meta name="keywords" content="历史公允价值变动与利润总额之比，历年公允价值变动与利润总额之比查询" />
<meta name="description" content="上市公司公允价值变动与利润总额之比查询，上市公司历年公允价值变动与利润总额之比走势图" />
...
<body>
	...
	<div class="report_tip">
		<span style="font-weight:bold;">指标名称：</span>公允价值变动 / 利润总额<br>
		<span style="font-weight:bold;">计算公式：</span> 公允价值变动 / 利润总额 × 100% <br>
		<span style="font-weight:bold;">说明：</span><br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;该指标为公允价值变动与利润总额的比率，主要查看公司在年度取得的利润中公允价值变动所占的百分比，从而判断公司核心业务的收益质量，公允价值变动只是账面的损益，并且不具有持续性，若该比值较大
		则说明本年度利润总额中很大一部分利润是"虚"的，今年的账面盈利，明年可能就亏损。主营业务未能成为贡献利润的主要力量。
	</div>
	<!-- 图标展示区 -->
