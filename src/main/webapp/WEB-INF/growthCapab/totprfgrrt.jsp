...
<meta charset="utf-8" />
<base href="<%=basePath%>">
<title>投资数据网 - 历史利润总额增长率走势图</title>
<meta name="viewport" content="width=1010" />
<meta name="keywords" content="历史利润总额增长率，历年利润总额增长率查询" />
<meta name="description" content="上市公司利润总额增长率查询，上市公司利润总额增长率走势图" />
...
<body>
	...
	<div class="report_tip">
		<span style="font-weight:bold;">指标名称：</span>利润总额增长率<br>
		<span style="font-weight:bold;">计算公式：</span> (期末利润总额-期初利润总额) / 期初利润总额  × 100% <br>
		<span style="font-weight:bold;">说明：</span><br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 利润总额增长率是指企业实现的全部利润（包括企业当年的营业利润、投资收益、补贴收入、营业外收支净额和所得税等项内容）的持续增长能力。
	</div>
	<!-- 图标展示区 -->
