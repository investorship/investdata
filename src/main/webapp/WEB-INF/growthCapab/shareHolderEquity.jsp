...
<body>
	...
	<div class="report_tip">
		<span style="font-weight:bold;">指标名称：</span>股东权益增长率<br>
		<span style="font-weight:bold;">计算公式：</span> (期末股东权益-期初股东权益) / 期初股东权益  × 100% <br>
		<span style="font-weight:bold;">说明：</span><br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 表示企业当年资本的积累能力，是评价企业发展潜力的重要指标。
	</div>
	<!-- 图标展示区 -->
