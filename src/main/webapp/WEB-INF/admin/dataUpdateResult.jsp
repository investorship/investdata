...
<body>
	<c:choose>
		...
		<c:when test="${operMethod == 'updateFinanceIndexInfo'}">
			<span style="font-weight: bold; font-size: 7px; color: #ff0000">
				管理菜单 >> 财务指标管理 >> 财务指标修改  >> 数据修改结果 </span>
			<hr />
			<br />
				修改财务指标数据成功 <a href="financeIndexMgr/financeIndexMgr!updateInput.action">继续修改</a>
		</c:when>
