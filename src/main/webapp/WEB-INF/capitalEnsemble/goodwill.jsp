...
<meta charset="utf-8" />
<base href="<%=basePath%>">
<title>投资数据网 - 历史商誉占净资产比率走势图查询</title>
<meta name="viewport" content="width=1010" />
<meta name="keywords" content="历史商誉占净资产比率，历年商誉占净资产比率查询" />
<meta name="description" content="上市公司历史商誉占净资产比率查询，上市公司历年商誉占净资产比率走势图" />
...
<body>
	...
	<div class="report_tip">
		<span style="font-weight:bold;">指标名称：</span>商誉占净资产比率<br>
		<span style="font-weight:bold;">计算公式：</span> 商誉 / 净资产(资产总额 - 负债总额) × 100%<br>
		<span style="font-weight:bold;">说明：</span><br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;用于展示商誉占净资产比比例，对于热衷于并购重组的公司来讲，商誉占净资产比率可能较高。如果曾经收购标的不达预期，甚至亏损，这些公司可能存在商誉减值隐忧。
	</div>
	<!-- 图标展示区 -->
