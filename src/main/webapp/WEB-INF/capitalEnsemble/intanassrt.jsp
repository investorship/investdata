...
<meta charset="utf-8" />
<base href="<%=basePath%>">
<title>投资数据网 - 历史无形资产比率走势图查询</title>
<meta name="viewport" content="width=1010" />
<meta name="keywords" content="历史无形资产比率，历年无形资产比率查询" />
<meta name="description" content="上市公司历史无形资产比率查询，上市公司历年无形资产比率走势图" />
...
<body>
	...
	<div class="report_tip">
		<span style="font-weight:bold;">指标名称：</span>无形资产比率<br>
		<span style="font-weight:bold;">计算公式：</span> 无形资产 / 资产总额  × 100%<br>
		<span style="font-weight:bold;">说明：</span><br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;无形资产（Intangible Assets）是指企业拥有或者控制的没有实物形态的可辨认非货币性资产，通过该比率可以看公司无形资产占总资产的比例。
	</div>
	<!-- 图标展示区 -->
