...
<meta charset="utf-8" />
<base href="<%=basePath%>">
<title>投资数据网 - 历史固定资产比率走势图查询</title>
<meta name="viewport" content="width=1010" />
<meta name="keywords" content="历史固定资产比率，历年固定资产比率查询" />
<meta name="description" content="上市公司历史固定资产比率查询，上市公司历年固定资产比率走势图" />
...
<body>
	...
	<div class="report_tip">
		<span style="font-weight:bold;">指标名称：</span>固定资产比率<br>
		<span style="font-weight:bold;">计算公式：</span> 固定资产总额 / 资产总额  × 100%<br>
		<span style="font-weight:bold;">说明：</span><br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;固定资产比率是指固定资产与资产总额之比,不同行业的固定资产比率存在较大差异，但固定资产比率越低企业资产才能更快的流动，从资金营运能力来看，固定资产比率越低企业营运能力越强。
	</div>
	<!-- 图标展示区 -->
