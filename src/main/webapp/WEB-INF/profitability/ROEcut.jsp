...
<meta charset="utf-8" />
<base href="<%=basePath%>">
<title>投资数据网 - 历史加权平均净资产收益率(扣非)走势图</title>
<meta name="viewport" content="width=1010" />
<meta name="keywords" content="历史加权平均净资产收益率(扣非)，历年加权平均净资产收益率(扣非)查询" />
<meta name="description" content="上市公司加权平均净资产收益率(扣非)，上市公司加权平均净资产收益率(扣非)走势图" />
...
<body>
	...
	<div class="report_tip">
		<span style="font-weight:bold;">指标名称：</span>加权平均净资产收益率(扣非)<br>
		<span style="font-weight:bold;">计算公式：</span>直接取自财报数据<br>
		<span style="font-weight:bold;">说明：</span><br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;加权平均净资产收益率(扣非)与加权平均净资产收益率的区别在于在计算收益时，扣除了非经常性损益的项目带来的影响。
	</div>
	<!-- 图标展示区 -->
